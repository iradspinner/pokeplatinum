...
| 29 | Aurora Veil, Hail, Recover, Splash | this batch; Aurora Veil fails before Hail, then goes up with "raised your team's Defense and Special Defense!", fails a second time, and wears off five turns later. Brick Break and Defog clearing it need a foe that sets one, which the kit does not have |
