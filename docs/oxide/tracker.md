...
- [ ] **The Battle Zone before the Elite Four** (Ian, 2026-09-25): scoped in `docs/oxide/battle-zone-plan.md`, nothing built yet. It spans three tracks: the ferry's gate and the dialogue for the main track, trainer levels for the balance track, and the wild tables for the encounter track. It ends in three questions for Ian, the largest being which split the zone opens in (Candice's, or after Volkner).
