...
#define SIDE_CONDITION_AURORA_VEIL  (1 << 15) // Oxide
...
#define FIELD_CONDITION_ECHOED_VOICE_0 (1 << 21) // Oxide: Echoed Voice's run of consecutive turns, 0 to 4, in three bits
#define FIELD_CONDITION_ECHOED_VOICE_1 (1 << 22)
#define FIELD_CONDITION_ECHOED_VOICE_2 (1 << 23)
#define FIELD_CONDITION_ECHOED_VOICE_THIS_TURN (1 << 24) // Oxide: some battler used Echoed Voice this turn
#define FIELD_CONDITION_ECHOED_VOICE_LAST_TURN (1 << 25) // Oxide: and the turn before
...
#define FIELD_CONDITION_ECHOED_VOICE    (FIELD_CONDITION_ECHOED_VOICE_0 | FIELD_CONDITION_ECHOED_VOICE_1 | FIELD_CONDITION_ECHOED_VOICE_2)

#define FIELD_CONDITION_UPROAR_SHIFT     8
#define FIELD_CONDITION_GRAVITY_SHIFT    12
#define FIELD_CONDITION_TRICK_ROOM_SHIFT 16
#define FIELD_CONDITION_ECHOED_VOICE_SHIFT 21
