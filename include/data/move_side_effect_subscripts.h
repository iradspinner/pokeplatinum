...
static const int sSideEffectSubscripts[] = {
    ...
    [MOVE_SUBSCRIPT_PTR_RAISE_ATTACK_AND_ACCURACY]        = subscript_raise_attack_and_accuracy,
    [MOVE_SUBSCRIPT_PTR_QUIVER_DANCE]                     = subscript_sp_atk_sp_def_speed_up,
    [MOVE_SUBSCRIPT_PTR_COIL]                             = subscript_atk_def_acc_up,
    [MOVE_SUBSCRIPT_PTR_SHIFT_GEAR]                       = subscript_shift_gear,
    [MOVE_SUBSCRIPT_PTR_SHELL_SMASH]                      = subscript_atk_sp_atk_speed_up_2_def_sp_def_down,
    [MOVE_SUBSCRIPT_PTR_V_CREATE]                         = subscript_user_def_sp_def_speed_down_hit,
    [MOVE_SUBSCRIPT_PTR_WORK_UP]                          = subscript_atk_sp_atk_up,
    [MOVE_SUBSCRIPT_PTR_SPICY_EXTRACT]                    = subscript_spicy_extract,
    [MOVE_SUBSCRIPT_PTR_FILLET_AWAY]                      = subscript_atk_sp_atk_speed_up_2_lose_half_max_hp,
    [MOVE_SUBSCRIPT_PTR_USER_DEF_DOWN_HIT]                = subscript_user_def_down_hit,
    [MOVE_SUBSCRIPT_PTR_HYPERSPACE_FURY]                  = subscript_hyperspace_fury,
    [MOVE_SUBSCRIPT_PTR_ATK_DEF_SPEED_UP]                 = subscript_atk_def_speed_up,
    [MOVE_SUBSCRIPT_PTR_CLANGOROUS_SOUL]                  = subscript_raise_all_stats_lose_third_max_hp,
    [MOVE_SUBSCRIPT_PTR_BURN_AND_DRAIN_HEALTH]            = subscript_burn_and_drain_health,
    [MOVE_SUBSCRIPT_PTR_TAKE_HEART]                       = subscript_take_heart,
    [MOVE_SUBSCRIPT_PTR_ENTRAINMENT]                      = subscript_entrainment,
    ...
    [MOVE_SUBSCRIPT_PTR_SP_DEFENSE_UP_3_STAGES]           = subscript_update_stat_stage,
    ...
    [MOVE_SUBSCRIPT_PTR_SP_ATTACK_DOWN_3_STAGES]          = subscript_update_stat_stage,
    [MOVE_SUBSCRIPT_PTR_SP_DEFENSE_DOWN_3_STAGES]         = subscript_update_stat_stage,
    ...
    [MOVE_SUBSCRIPT_PTR_MORTAL_SPIN]                      = subscript_mortal_spin,
    [MOVE_SUBSCRIPT_PTR_PREVENT_ESCAPE_HIT]               = subscript_prevent_escape_hit,
    ...
    [MOVE_SUBSCRIPT_PTR_DRAIN_THREE_QUARTERS]             = subscript_drain_three_quarters,
    [MOVE_SUBSCRIPT_PTR_ATK_SP_ATK_DOWN]                  = subscript_atk_sp_atk_down,
    [MOVE_SUBSCRIPT_PTR_ATK_SP_ATK_SPEED_DOWN]            = subscript_atk_sp_atk_speed_down,
    [MOVE_SUBSCRIPT_PTR_COACHING]                         = subscript_coaching,
