...
_000:
    ...
    CheckAbility CHECK_HAVE, BTLSCR_SIDE_EFFECT_MON, ABILITY_PURIFYING_SALT, _249 // Oxide
    CheckAbility CHECK_HAVE_ON_SIDE, BTLSCR_SIDE_EFFECT_MON, ABILITY_PASTEL_VEIL, _249 // Oxide: it or its partner
...
_023:
    ...
    CheckAbility CHECK_HAVE, BTLSCR_SIDE_EFFECT_MON, ABILITY_PURIFYING_SALT, _248 // Oxide
    CheckAbility CHECK_HAVE_ON_SIDE, BTLSCR_SIDE_EFFECT_MON, ABILITY_PASTEL_VEIL, _248 // Oxide: it or its partner
...
_045:
    ...
    // Oxide: a poison its holder inflicts with a move reaches Poison and
    // Steel types when the holder has Corrosion.
    CompareVarToValue OPCODE_EQU, BTLVAR_SIDE_EFFECT_TYPE, SIDE_EFFECT_TYPE_DIRECT, _corrosion_1_check
    CompareVarToValue OPCODE_NEQ, BTLVAR_SIDE_EFFECT_TYPE, SIDE_EFFECT_TYPE_INDIRECT, _corrosion_1_types

_corrosion_1_check:
    CheckAbility CHECK_HAVE, BTLSCR_ATTACKER, ABILITY_CORROSION, _corrosion_1_done
...
_094:
    ...
    CheckIgnorableAbility CHECK_HAVE, BTLSCR_SIDE_EFFECT_MON, ABILITY_PURIFYING_SALT, _249 // Oxide
    CheckIgnorableAbility CHECK_HAVE_ON_SIDE, BTLSCR_SIDE_EFFECT_MON, ABILITY_PASTEL_VEIL, _249 // Oxide: it or its partner
...
_128:
    ...
    // Oxide: a poison its holder inflicts with a move reaches Poison and
    // Steel types when the holder has Corrosion.
    CompareVarToValue OPCODE_EQU, BTLVAR_SIDE_EFFECT_TYPE, SIDE_EFFECT_TYPE_DIRECT, _corrosion_2_check
    CompareVarToValue OPCODE_NEQ, BTLVAR_SIDE_EFFECT_TYPE, SIDE_EFFECT_TYPE_INDIRECT, _corrosion_2_types

_corrosion_2_check:
    CheckAbility CHECK_HAVE, BTLSCR_ATTACKER, ABILITY_CORROSION, _corrosion_2_done
