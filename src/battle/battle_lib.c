...
static const u16 sCannotMetronomeMoves[] = {
    ...
    MOVE_ME_FIRST,
    MOVE_SWITCHEROO,
    // Platinum Oxide: the roll is now over 1..922, which reaches the three retail
    // placeholder records (name "-", a 100-power hit with the example animation)
    // and the Z-moves, imported as inert 0-power data to keep the ids contiguous.
    // None of them is a move a Pokemon can use, so Metronome, Assist, Sleep Talk
    // and Copycat must not pick them. Found by the 2026-09-22 code review.
    MOVE_UNUSED_468,
    MOVE_UNUSED_469,
    MOVE_UNUSED_470,
    MOVE_BREAKNECK_BLITZ_PHYSICAL,
    MOVE_BREAKNECK_BLITZ_SPECIAL,
    MOVE_ALL_OUT_PUMMEL_PHYSICAL,
    MOVE_ALL_OUT_PUMMEL_SPECIAL,
    MOVE_SUPER_SKYSTRIKE_PHYSICAL,
    MOVE_SUPER_SKYSTRIKE_SPECIAL,
    MOVE_ACID_DOWNPOUR_PHYSICAL,
    MOVE_ACID_DOWNPOUR_SPECIAL,
    MOVE_TECTONIC_RAGE_PHYSICAL,
    MOVE_TECTONIC_RAGE_SPECIAL,
    MOVE_CONTINENT_CRUSH_PHYSICAL,
    MOVE_CONTINENT_CRUSH_SPECIAL,
    MOVE_SAVAGE_SPIN_OUT_PHYSICAL,
    MOVE_SAVAGE_SPIN_OUT_SPECIAL,
    MOVE_ENDLESS_NITEMARE_PHYSICAL,
    MOVE_ENDLESS_NITEMARE_SPECIAL,
    MOVE_CORKSCREW_CRASH_PHYSICAL,
    MOVE_CORKSCREW_CRASH_SPECIAL,
    MOVE_INFERNO_DRIVE_PHYSICAL,
    MOVE_INFERNO_DRIVE_SPECIAL,
    ...
    MOVE_ULTIMATE_DRAKE_PHYSICAL,
    MOVE_ULTIMATE_DRAKE_SPECIAL,
    MOVE_BLACK_ECLIPSE_PHYSICAL,
