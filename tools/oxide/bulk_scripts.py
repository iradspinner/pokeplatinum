...
# Swarms are gone (Ian, 2026-09-26), so the rival's younger sibling in Sandgem
# no longer turns on swarms or reports one once the game is beaten; she keeps
# her ordinary line. Regenerating would announce a swarm of an empty slot.
DIVERGED["scripts_sandgem_town_counterpart_house_1f"] = (
    "the swarm announcement removed; swarms are off in the engine "
